...
public class SpellingCorrector {
    ...
    public static int editDistance(String a, String b) {
        ...
        if (a.charAt(m - 1) == b.charAt(n - 1))
            return editDistance(a.substring(m - 1), b.substring(n - 1));
        return 1 + min(editDistance(a, b.substring(n - 1)),
                editDistance(a.substring(m - 1), b),
                editDistance(a.substring(m - 1), b.substring(n - 1)));
        */

        // Big boy implementation
